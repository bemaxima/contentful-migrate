...
describe('createChangeFieldControl', () => {
  it('creates changeFieldControl without settings', () => {
    ...
    const field = { fieldId: 'unicornDestroyer', widgetId: 'number', widgetNamespace: 'builtin' }
...
describe('jsonToScript', () => {
  ...
  const editorInterface = [
    { fieldId: 'unicornDestroyer', widgetId: 'number', widgetNamespace: 'builtin' },
    {
      fieldId: 'pegasusLauncher',
      widgetId: 'radio',
      widgetNamespace: 'builtin',
  ...
  it('generates description, up and down', async () => {
    const actual = await jsonToScript(contentType, editorInterface, '.js')
